...
plt.ylim(28,42)
plt.legend(loc="best")
plt.savefig("../Bilder/M1-4_verb.pdf")
plt.show()
plt.close()
...
max1=ufloat(np.max(f(np.linspace(0,7,10000),*params)),0.52)
print('')
print('Maximum2')
print(max1)
min1=ufloat(np.min(f(np.linspace(0,7,10000),*params)),0.53)
print('Minimum1')
print(min1)
print('')
...
plt.errorbar(np.radians(135),unp.nominal_values(U_4),unp.std_devs(U_4),fmt='kx',label="Ausgewerte Daten") 
plt.errorbar(np.radians(180),unp.nominal_values(U_5),unp.std_devs(U_5),fmt='rx')
...
max2=ufloat(np.max(f(np.linspace(0,7,10000),*params)),0.26)
print('')
print('Maximum2')
print(max2)
min2=ufloat(np.min(f(np.linspace(0,7,10000),*params)),0.26)
print('Minimum2')
print(min2)
print('')
print('a =', params[0], 'pm', errors[0])
