...
#
max_M2_T1,min_M2_T1 = peakdetect.peakdetect(T1_M2,Zeit_M2,1,0)
max_M2_T2,min_M2_T2 = peakdetect.peakdetect(T2_M2,Zeit_M2,1,0)
max_M2_T5,min_M2_T5 = peakdetect.peakdetect(T5_M2,Zeit_M2,1,0)
max_M2_T6,min_M2_T6 = peakdetect.peakdetect(T6_M2,Zeit_M2,1,0)
...
plt.plot(Zeit_M2,T1_M2, "b-",label="kühles Ende")
...
plt.plot(Zeit_M2,T6_M2, "r-",label="warmes Ende")
...
plt.plot(Zeit_M2,T1_M2-f(Zeit_M2,*coeffx),"g-",label="Ampl.fkt. oben")
plt.plot(Zeit_M2,T1_M2-f(Zeit_M2,*coeffn),"y--")
coeffx, covar = curve_fit(f,max_M2_T2[0],max_M2_T2[1], p0=(1, 1e-6, 1))
coeffn, covar = curve_fit(f,min_M2_T2[0],min_M2_T2[1], p0=(1, 1e-6, 1))
plt.plot(Zeit_M2,T2_M2-f(Zeit_M2,*coeffx),"g-")
plt.plot(Zeit_M2,T2_M2-f(Zeit_M2,*coeffn),"y--",label="Ampl.fkt. unten")
...
coeffx, covar = curve_fit(f,max_M2_T1[0],max_M2_T1[1], p0=(1, 1e-6, 1))
Junk1, Zeit_M2_norm, Junk2 = np.split(Zeit_M2,[50, 350])
Junk1, T1_M2_norm, Junk2= np.split(T1_M2-f(Zeit_M2,*coeffx),[50, 350])
plt.plot(Zeit_M2_norm,T1_M2_norm,"b-",label="Grundschwingung, fern")
coeffx, covar = curve_fit(f,max_M2_T2[0],max_M2_T2[1], p0=(1, 1e-6, 1))
Junk1, T2_M2_norm, Junk2= np.split(T2_M2-f(Zeit_M2,*coeffx),[50, 350])
plt.plot(Zeit_M2_norm,T2_M2_norm,"r-",label="Grundschwingung, nah")
plt.legend(loc="upper left")
plt.ylim(-7,2)
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
max_M2_T1_furt,min_M2_T1_furt = peakdetect.peakdetect(T1_M2_norm,Zeit_M2_norm,1,0)
max_M2_T2_furt,min_M2_T2_furt = peakdetect.peakdetect(T2_M2_norm,Zeit_M2_norm,1,0)
...
np.savetxt('../Tabellen/M2_Mess_T1_max.txt', np.array([max_M2_T1_furt_x,max_M2_T1_furt_y]).T, header="Messung 2 - Maxima\nT1\nx\t y\t x\t y")
np.savetxt('../Tabellen/M2_Mess_T2_max.txt', np.array([max_M2_T2_furt_x,max_M2_T2_furt_y]).T, header="Messung 2 - Maxima\nT2\nx\t y\t x\t y")
np.savetxt('../Tabellen/M2_Mess_T1_min.txt', np.array([min_M2_T1_furt_x,min_M2_T1_furt_y]).T, header="Messung 2 - Minima\nT1\nx\t y\t x\t y")
np.savetxt('../Tabellen/M2_Mess_T2_min.txt', np.array([min_M2_T2_furt_x,min_M2_T2_furt_y]).T, header="Messung 2 - Minima\nT2\nx\t y\t x\t y")
...
#np.savetxt('../Tabellen/M3_Messing_T1_max.txt', np.array([max_M3_T1_furt_x,max_M3_T1_furt_y]).T, header="Messung 3 - Maxima\nT1\nx\t y")
#np.savetxt('../Tabellen/M3_Messing_T2_max.txt', np.array([max_M3_T2_furt_x,max_M3_T2_furt_y]).T, header="Messung 3 - Maxima\nT2\nx\t y")
#np.savetxt('../Tabellen/M3_Messing_T1_min.txt', np.array([min_M3_T1_furt_x,min_M3_T1_furt_y]).T, header="Messung 3 - Minima\nT1\nx\t y")
#np.savetxt('../Tabellen/M3_Messing_T2_min.txt', np.array([min_M3_T2_furt_x,min_M3_T2_furt_y]).T, header="Messung 3 - Minima\nT2\nx\t y")
...
plt.plot(Zeit_M2,T5_M2, "b-",label="kühles Ende")
...
plt.plot(Zeit_M2,T5_M2-f(Zeit_M2,*coeffx),"g-",label="Ampl.fkt. oben")
plt.plot(Zeit_M2,T5_M2-f(Zeit_M2,*coeffn),"y--")
coeffx, covar = curve_fit(f,max_M2_T6[0],max_M2_T6[1], p0=(1, 1e-6, 1))
coeffn, covar = curve_fit(f,min_M2_T6[0],min_M2_T6[1], p0=(1, 1e-6, 1))
plt.plot(Zeit_M2,T6_M2-f(Zeit_M2,*coeffx),"g-")
plt.plot(Zeit_M2,T6_M2-f(Zeit_M2,*coeffn),"y--",label="Ampl.fkt. unten")
plt.legend(loc="best")
plt.ylim(-10,10)
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
...
coeffx, covar = curve_fit(f,max_M2_T5[0],max_M2_T5[1], p0=(1, 1e-6, 1))
Junk1, Zeit_M2_norm, Junk2 = np.split(Zeit_M2,[50, 350])
Junk1, T5_M2_norm, Junk2= np.split(T5_M2-f(Zeit_M2,*coeffx),[50, 350])
plt.plot(Zeit_M2_norm,T5_M2_norm,"b-",label="Grundschwingung, fern")
coeffx, covar = curve_fit(f,max_M2_T6[0],max_M2_T6[1], p0=(1, 1e-6, 1))
Junk1, T6_M2_norm, Junk2= np.split(T6_M2-f(Zeit_M2,*coeffx),[50, 350])
plt.plot(Zeit_M2_norm,T6_M2_norm,"r-",label="Grundschwingung, nah")
plt.legend(loc="upper left")
plt.ylim(-7,2)
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
max_M2_T6_furt,min_M2_T6_furt = peakdetect.peakdetect(T6_M2_norm,Zeit_M2_norm,1,0.01)
max_M2_T5_furt,min_M2_T5_furt = peakdetect.peakdetect(T5_M2_norm,Zeit_M2_norm,1,0)
...
np.savetxt('../Tabellen/M2_Alu_T5_max.txt', np.array([max_M2_T5_furt_x,max_M2_T5_furt_y]).T, header="Messung 2 - Maxima\nT6\nx\t y")
np.savetxt('../Tabellen/M2_Alu_T6_max.txt', np.array([max_M2_T6_furt_x,max_M2_T6_furt_y]).T, header="Messung 2 - Maxima\nT5\nx\t y")
np.savetxt('../Tabellen/M2_Alu_T5_min.txt', np.array([min_M2_T5_furt_x,min_M2_T5_furt_y]).T, header="Messung 2 - Minima\nT5\nx\t y")
np.savetxt('../Tabellen/M2_Alu_T6_min.txt', np.array([min_M2_T6_furt_x,min_M2_T6_furt_y]).T, header="Messung 2 - Minima\nT6\nx\t y")
...
np.savetxt('../Tabellen/M3_Edelstahl_T7_max.txt', np.array([max_M3_T7_furt_x,max_M3_T7_furt_y]).T, header="Messung 3 - Maxima\nT7\nx\t y")
np.savetxt('../Tabellen/M3_Edelstahl_T8_max.txt', np.array([max_M3_T8_furt_x,max_M3_T8_furt_y]).T, header="Messung 3 - Maxima\nT8\nx\t y")
np.savetxt('../Tabellen/M3_Edelstahl_T7_min.txt', np.array([min_M3_T7_furt_x,min_M3_T7_furt_y]).T, header="Messung 3 - Minima\nT7\nx\t y")
np.savetxt('../Tabellen/M3_Edelstahl_T8_min.txt', np.array([min_M3_T8_furt_x,min_M3_T8_furt_y]).T, header="Messung 3 - Minima\nT8\nx\t y")
plt.grid()
