...
Bei Erregung des Systems mit dieser Frequenz kommt es zur Resonanz; das System schwingt mit einer Spannungsamplitude größer als die Erregeramplitude $U_0$.
Es gilt dabei, dass die maximale Spannung
\begin{equation}
	U_\mathup{C,max=} \underbrace{\frac{1}{\mathup{\omega_0RC}}}_{\text{Spannungsüberhöhung}} U_0 
\end{equation}
