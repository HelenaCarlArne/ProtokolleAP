...
In Tabelle \ref{tabf_t} ist die frequenzabhängige Zeitdifferenz $\Delta{t}$ zwischen den Nulldurchgängen der Sinusspannung des Frequenzgenerators und der Kondensatorspannung aufgetragen. 
\begin{table}	
\centering
\setlength{\tabcolsep}{2mm}
\begin{tabular}{cc}
