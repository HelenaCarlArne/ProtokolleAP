...
# plt.plot(t_M2_norm,T1_M2_norm,"b-",label="Grundschwingung, entfernt")
# coeffx, covar = curve_fit(f,max_M2_T2[0],max_M2_T2[1], p0=(1, 1e-6, 1))
...
# max_M2_T1_furt,min_M2_T1_furt = peakdetect.peakdetect(T1_M2_norm,t_M2_norm,1,0.01)
...
# plt.plot(t_M3_norm,T1_M3_norm,"b-",label="Grundschwingung, entfernt")
# coeffx, covar = curve_fit(f,max_M3_T2[0],max_M3_T2[1], p0=(1, 1e-6, 1))
...
# plt.plot(t_M2_norm,T5_M2_norm,"b-",label="Grundschwingung, entfernt")
# coeffx, covar = curve_fit(f,max_M2_T6[0],max_M2_T6[1], p0=(1, 1e-6, 1))
...
# plt.plot(t_M3_norm,T5_M3_norm,"b-",label="Grundschwingung, entfernt")
# coeffx, covar = curve_fit(f,max_M3_T6[0],max_M3_T6[1], p0=(1, 1e-6, 1))
...
# coeffx, covar = curve_fit(f,max_M3_T8[0],max_M3_T8[1], p0=(1, 1e-6, 1))
# Junk1, t_M3_norm, Junk2 = np.split(t_M3,[120, 900])
# Junk1, T8_M3_norm, Junk2= np.split(T8_M3/f(t_M3,*coeffx),[120, 900])
# plt.plot(t_M3_norm,T8_M3_norm,"b-",label="Grundschwingung, entfernt")
# coeffx, covar = curve_fit(f,max_M3_T7[0],max_M3_T7[1], p0=(1, 1e-6, 1))
# Junk1, T7_M3_norm, Junk2= np.split(T7_M3/f(t_M3,*coeffx),[120, 900])
