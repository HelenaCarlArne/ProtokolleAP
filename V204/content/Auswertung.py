...
coeff, covar = curve_fit(f,max_M2_T2[0],max_M2_T2[1], p0=(1, 1e-6, 1))
plt.plot(max_M2_T2[0],f(max_M2_T2[0],*coeff),"k--")
coeff, covar = curve_fit(f,min_M2_T2[0],min_M2_T2[1], p0=(1, 1e-6, 1))
plt.plot(min_M2_T2[0],f(min_M2_T2[0],*coeff),"k--")
...
plt.plot(max_M2_T2_d[0],max_M2_T2_d[1],"kx")
plt.plot(min_M2_T2_d[0],min_M2_T2_d[1],"kx")
plt.legend(loc="best")
plt.title(r"Temperaturwellen in Messing")
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
plt.savefig("../Bilder/M2_Messing.pdf")
plt.show()
...
plt.plot(max_M3_T2[0],f(max_M3_T2[0],*coeff),"k--")
...
plt.plot(max_M3_T2[0],max_M3_T2[1],"kx")
plt.plot(min_M3_T2[0],min_M3_T2[1],"kx")
plt.legend(loc="best")
plt.title(r"Temperaturwellen in Messing")
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
plt.savefig("../Bilder/M3_Messing.pdf")
plt.show()
...
plt.plot(max_M2_T6[0],f(max_M2_T6[0],*coeff),"k--")
...
plt.plot(max_M3_T6[0],f(max_M3_T6[0],*coeff),"k--")
