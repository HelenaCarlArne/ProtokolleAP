...
ID_M2, T1_M2, T5_M2, T2_M2, T6_M2, Time_M2 = np.genfromtxt("Originalwerte/Messung80").T 
...
plt.grid()
plt.savefig("Bilder/M1_Overview.pdf")
plt.show()
...
plt.plot(t_M1,T6_M1-T5_M1, "-",label="Temperaturdifferenz Aluminium")
plt.plot(t_M1,T3_M1-T4_M1, "-",label="Temperaturdifferenz Messing, dünn")
plt.legend(loc="best")
plt.xlabel(r"Zeit $t [s]$")
plt.ylabel(r"Temperatur [$^{\circ}{\rm C}$]")
plt.grid()
