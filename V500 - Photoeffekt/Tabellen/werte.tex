\begin{landscape}
	\begin{minipage}[c][12cm][t]{0.3\textwidth}
		...
		\begin{tabular}{S[table-format=1.2] S[table-format=3.0]}
			...
			{$U_\text{G}/\:\si{\volt}$} & {$I/\:\si{\pico\ampere}$}\\	
			\midrule
				 0.20 & 200\\
				 0.30 & 190\\
				 0.40 & 160\\
	...
	\end{minipage}
\begin{table}[ht]
\caption{Die gemessenen Gegenspannungen \texorpdfstring{$U_\text{G}$}{U} und Photoströme \texorpdfstring{$I$}{I} in Abhängigkeit von der Wellenlänge \texorpdfstring{$\lambda$}{} des Lichtes.}
\label{tab:messwerte}
\end{table}
\end{landscape}
