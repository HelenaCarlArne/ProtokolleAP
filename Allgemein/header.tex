...
%%%%%%%ab hier kommt bloedsinn%%%%%%%%%%%%%%%

%Fledermaeuse machen mit \Bat im textmode
%Faxgerät mit \Faxmachine im textmode
%Herz mit \Heart oder \heartsuit
\usepackage{ marvosym }
%\Sternchen mit \bigstar im mathmode
\usepackage{amssymb}
%Totenschaedel mit \skull
%\usepackage{ skull }
\author{
  Helena Nawrath
  \texorpdfstring{
