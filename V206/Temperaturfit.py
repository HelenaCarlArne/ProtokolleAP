...
print('a =',params[0],'+/-',errors[0],'K/s³')
print('b =',params[1],'+/-',errors[1],'K/s²')
print('c =',params[2],'+/-',errors[2],'K/s')
print('d =',params[3],'+/-',errors[3],'K')
t_plot = np.linspace(0, 19)
...
print('g =',params[2],'+/-',errors[2])
print('h =',params[3],'+/-',errors[3])
...
dT1_dt_1= 3*a*120+2*b*120+c
dT1_dt_2= 3*a*480+2*b*480+c
dT1_dt_3= 3*a*840+2*b*840+c
dT1_dt_4= 3*a*1080+2*b*1080+c

dT2_dt_1= 3*e*120+2*f*120+g
dT2_dt_2= 3*e*480+2*f*480+g
dT2_dt_3= 3*e*840+2*f*840+g
dT2_dt_4= 3*e*1080+2*f*1080+g
