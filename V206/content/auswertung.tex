...
bestimmt wird.
Daraus ergibt sich 
%benutzen wir P statt N?
\begin{equation}
\nu=\frac{\Delta{Q_1}{{\Delta{t}P_\mathup{el.}}
\label{waermemenge/zeitintervall}
für die reale Güteziffer. $P_\mathup{el.}=201.39\pm$ ist dabei das Mittel der mit dem Wattmeter gemessenen elektrischen Leistung des Kondensators.
